...
hljs.registerLanguage("less", function (e) {
    ...
    var a = "[\\w-]+", c = "(" + a + "|@{" + a + "})", s = [], b = [], n = {b: "\\(", e: "\\)", c: b, r: 0};
    b.push(e.CLCM, e.CBCM, r("'"), r('"'), e.CSSNM, {
        b: "(url|data-uri)\\(",
        starts: {cN: "string", e: "[\\)\\n]", eE: !0}
    }, t("number", "#[0-9A-Fa-f]+\\b"), n, t("variable", "@@?" + a, 10), t("variable", "@{" + a + "}"), t("built_in", "~?`[^`]*?`"), {
        cN: "attribute",
        b: a + "\\s*:",
        e: ":",
        rB: !0,
    ...
    var i = b.concat({b: "{", e: "}", c: s}), o = {bK: "when", eW: !0, c: [{bK: "and not"}].concat(b)}, u = {
        b: c + "\\s*:",
        rB: !0,
        e: "[;}]",
        r: 0,
        c: [{cN: "attribute", b: c, e: ":", eE: !0, starts: {eW: !0, i: "[<=$]", r: 0, c: b}}]
    }, l = {
        cN: "keyword",
        b: "@(import|media|charset|font-face|(-[a-z]+-)?keyframes|supports|document|namespace|page|viewport|host)\\b",
        starts: {e: "[;{}]", rE: !0, c: b, r: 0}
    }, C = {cN: "variable", v: [{b: "@" + a + "\\s*:", r: 15}, {b: "@" + a}], starts: {e: "[;}]", rE: !0, c: i}}, p = {
        v: [{b: "[\\.#:&\\[>]", e: "[;{}]"}, {b: c, e: "{"}],
        rB: !0,
        rE: !0,
        i: "[<='$\"]",
        r: 0,
        c: [e.CLCM, e.CBCM, o, t("keyword", "all\\b"), t("variable", "@{" + a + "}"), t("selector-tag", c + "%?", 0), t("selector-id", "#" + c), t("selector-class", "\\." + c, 0), t("selector-tag", "&", 0), {
            cN: "selector-attr",
            b: "\\[",
            e: "\\]"
    ...
    var b = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?", r = {
        ...
        n = {cN: "subst", b: "#\\{", e: "}", k: r}, t = {
            ...
            v: [{b: /'/, e: /'/}, {b: /"/, e: /"/}, {b: /`/, e: /`/}, {b: "%[qQwWx]?\\(", e: "\\)"}, {
                ...
                b: /<<[-~]?'?(\w+)(?:.|\n)*?\n\s*\1\b/,
                rB: !0,
                c: [{b: /<<[-~]?'?/}, {b: /\w+/, endSameAsBegin: !0, c: [e.BE, n]}]
            }]
...
hljs.registerLanguage("yaml", function (e) {
    var b = "true false yes no null", a = "^[ \\-]*", r = "[a-zA-Z_][\\w\\-]*",
        t = {cN: "attr", v: [{b: a + r + ":"}, {b: a + '"' + r + '":'}, {b: a + "'" + r + "':"}]}, c = {
            cN: "string",
            r: 0,
            v: [{b: /'/, e: /'/}, {b: /"/, e: /"/}, {b: /\S+/}],
    ...
    return {
        ...
        c: [t, {cN: "meta", b: "^---s*$", r: 10}, {
            ...
            cN: "type",
            b: "!!" + e.UIR
        }, {cN: "meta", b: "&" + e.UIR + "$"}, {cN: "meta", b: "\\*" + e.UIR + "$"}, {
            cN: "bullet",
            b: "^ *-",
            r: 0
        }, e.HCM, {bK: b, k: {literal: b}}, e.CNM, c]
    }
});
...
hljs.registerLanguage("powershell", function (e) {
    var t = {b: "`[\\s\\S]", r: 0}, o = {cN: "variable", v: [{b: /\$[\w\d][\w\d_:]*/}]}, r = {
        cN: "string",
        v: [{b: /"/, e: /"/}, {b: /@"/, e: /^"@/}],
    ...
    return {
        ...
        c: [t, e.NM, r, {cN: "string", v: [{b: /'/, e: /'/}, {b: /@'/, e: /^'@/}]}, {
            cN: "literal",
            b: /\$(null|true|false)\b/
        }, o, i]
    }
